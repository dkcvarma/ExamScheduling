...
$document_get = mysqli_query($connection,"SELECT * FROM admin_details WHERE username='$username'");
...
?>
<br>
 <div style="margin-left:-25%;"> <a href="#addnote" role="button" class="btn" data-toggle="modal" >Add Note</a> </div>
 <div id="containment-wrapper" style="position: absolute; width: 100%; left: 0px; right: 0px; height: 100%; border:transparent; ">
  <?php
