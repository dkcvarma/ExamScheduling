                                ...
                                <div class="author">	
									<div class="dropdown">
										...
										<ul class="dropdown-menu" style="padding: 10px;">
											<form method="post" action="../module1/image.php" enctype="multipart/form-data">
												<li>
                                    ...
                                    <h4 class="title"><?php echo $f_name . " " . $l_name ?><br /><small style="font-size: 20px;">Faculty</small><br /><small style="font-size: 20px;"><?php echo $dept ?></small></h4>
                                </div>
							</div> 
