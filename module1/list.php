                ...
                <div class="row">
					<div class="col-md-12">
                        <div class="card"> <!-- <div class="card card-plain">-->
                            <div class="header">
                                <h4 class="title">Time Table for Faculty ID: <?php echo $id ?></h4>
                                <p class="category">Here are your details for your invigilation</p>
                            </div>
                            <div class="content table-responsive table-full-width">
							<?php
										$sql = "SELECT exam_details.exam_id, exam_details.exam_name, exam_details.exam_dept,department.location, exam_details.date FROM exam_details inner join registration1 on exam_details.exam_id=registration1.exam_id inner join department on exam_details.exam_dept=department.exam_dept where fact_id='$id' order by date asc";
